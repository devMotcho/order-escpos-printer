...
public class EscPosPrinterClient implements PrinterClient {
  ...
  public void printOrder(Order order) throws Exception {
    try {
      ...
      if (!nif.isEmpty() && !nif.equalsIgnoreCase("0") && !nif.matches("^0+$") && !nif.equalsIgnoreCase("N/D")
          && !nif.equalsIgnoreCase("null")) {
        printText("NIF: " + nif + "\n");
      }
  ...
  private String formatPtPtDateTime(String dateStr) {
    if (dateStr == null || dateStr.isEmpty() || dateStr.equals("N/D"))
      return "N/D";
